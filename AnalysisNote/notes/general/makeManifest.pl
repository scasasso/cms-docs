...
my $VERSION = sprintf "%d.%03d", q$Revision: 109745 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 109745 $
   # \RCS$Date: 2012-03-09 12:15:16 +0100 (Fri, 09 Mar 2012) $
   # \RCS$HeadURL: svn+ssh://emiglior@svn.cern.ch/reps/tdr2/utils/trunk/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 109745 2012-03-09 11:15:16Z alverson $
