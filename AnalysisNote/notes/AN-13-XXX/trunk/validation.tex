...
\begin{figure}[hbtp]  
  ...
  \end{center}
  \caption{Examples of fits to the dimuon spectrum in the J/$\psi$ region in different $p_T$ bins 
    for simulation \subref{fig:JPsiFitExample_MC} and data \subref{fig:JPsiFitExample_DATA}.
...
\begin{figure}[hbtp]  
  ...
  \end{center}
  \caption{Examples of fits to the dimuon spectrum in the $Y$ region in different $p_T$ bins 
    for simulation \subref{fig:UpsilonFitExample_MC} and data \subref{fig:UpsilonFitExample_DATA}.
...
\begin{figure}[hbtp]  
  ...
  \end{center}
  \caption{Examples of fits to the dimuon spectrum in the $Z$ region in different $p_T$ bins 
    for simulation \subref{fig:ZFitExample_MC} and data \subref{fig:ZFitExample_DATA}.
