...
[0,0.8], [0.8,2.4]. A 2D representation of the signal model as a function of the dimuon mass 
and the dimuon resolution is in Figure \ref{fig:lineshape}.\\
...
\caption{Datasets corresponding to the different samples of data and
  simulated events used for the study of the muon momentum scale at the LHC
...
\hline
Energy & Type & Dataset name & Label \\
\hline
