...
\RCS$Revision: 127559 $
\RCS$Id: notes_for_authors.tex 127559 2012-06-05 13:24:16Z alverson $
\RCS$HeadURL: svn+ssh://emiglior@svn.cern.ch/reps/tdr2/utils/branches/dev/general/notes_for_authors.tex $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
\begin{description}
\item[APS] use the normal command for a paper, but add the appropriate APS options with, e.g., \texttt{--aps="reprint,prl,linenumbers"}. See the revtex documentation for details on APS options. Information on the revtex style for use with APS journals can be found at \url{http://authors.aps.org/revtex4/} and download sites are listed at \url{https://authors.aps.org/revtex4/revtex4_faq.html#download}.
